...
| RTC | PCF8563, RX8130, PowerHub RTC; date/time, alarms, timer IRQ, low-voltage status | PCF8563 and RX8130 validated date/time, alarms, timer IRQ, and low-voltage APIs build-verified; PowerHub pending |
