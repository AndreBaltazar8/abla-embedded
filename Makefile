...
.PHONY: setup check blink serial i2c-scan spi-jedec sd-card rtc-pcf8563 rtc-rx8130 rtc-powerhub io-expander imu imu-calibration imu-offsets power-monitor pmic-axp192 pmic-axp2101 pmic-ip5306 pmic-m5pm1 charger-aw32001 led-m5pm1 led-powerhub led-paper-mono led-strip-rmt board-detect-s3 board-detect-c6 radio-mac-registers compare-radio-power-size compare-rx-chain-size compare-wifi-fcs-size compare-xtensa-interrupt-size compare-radio-rx-size compare-radio-rx-queue-size compare-radio-tx-size i2s-tone wifi-connect atom-echo \
